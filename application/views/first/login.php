...
<input type="password"  name="password" class="input-block-level" placeholder="Kata Sandi">
       
<button class="btn btn-primary" type="submit"  id="submit" value="Login" >Masuk</button>

<a href="<?php echo site_url('siteman/forgot_password');?>"> Lupa kata sandi?  </a>
<a href="<?php echo site_url('siteman/register');?>"> Daftar?  </a>
