...
<?php foreach ($statistik->result() as $data) : ?>
	<tr>
	<td><?php echo anchor('statistik/detail/kecamatan',$data->nama); ?></td>
	<td><?php echo anchor("statistik/detail/desa/$data->id",$this->statistik_model->get_count_desa_kec($data->id)); ?></td>	
	<td><?php echo anchor('statistik/detail/pelapor',$this->statistik_model->get_count_lap_kab($data->id)); ?></td>		
	</tr>
<?php endforeach ?>
