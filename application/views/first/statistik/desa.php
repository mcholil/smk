...
<?php foreach ($statistik->result() as $data) : ?>
	<tr>
	<td><?php echo anchor('statistik/folder/kecamatan',$data->nama); ?></td>
	<td><?php echo anchor('statistik/folder/pelapor', $this->statistik_model->get_count_lap_desa($data->id));  ?></td>		
	</tr>
<?php endforeach; ?>
