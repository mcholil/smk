...
<!-- BEGIN FORM-->
<?php echo form_open('proses/update/arsip', array('class' => 'form-horizontal'));?>
	<fieldset>
	...
	<div class="control-group">
        ...
        <div class="controls">
        <input type="text" class="input-xlarge datepicker" id="date01"  value="<?php if(isset($proses)) echo $proses->row('tgl_arsip');?>">
        </div>
        </div>
...
<?php echo anchor('proses/folder/arsip','Batal', 'class="btn btn-primary"'); ?>
		</div>				
